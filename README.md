...
o  Posts by the user, in chronologically descending order. It is sufficient to return top 1 media file for each post
...
6. Number of user registrations by date (will return as many rows as there are unique dates)
...
7. User division by gender (should return 3 rows, one for each gender)
